...
parser.add_argument('--model_type', type=str, default=None, help='模型类型: base, cot_text, csc_audio, csc_video, csc_av, cot, enhanced, text_audio_enhanced')
...
if hasattr(opt, 'model_type') and opt.model_type is not None:
    if not hasattr(args.model, 'model_type'):
        setattr(args.model, 'model_type', opt.model_type)
    else:
        args.model.model_type = opt.model_type
